package com.ssau.chord.model.start;

import com.ssau.chord.model.controller.Controller;
import com.ssau.chord.model.controller.SocketController;
            ...
            switch (choice) {
                ...
                case LOOKUP_COMMAND:
                    ...
                    try {
                        ...
                        out.println("Node is found: " + prova.getNodeId());
                    } catch (IOException e) {
                        e.printStackTrace();
